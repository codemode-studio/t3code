...
desktop is blurred. On macOS and Linux, turning translucency on takes effect after you quit and
reopen T3 Code, and on Linux your compositor controls the blur. Windows 11 22H2 or later applies it
immediately.
